 ...
 */
class BraftonArticlesModelOptions_Video extends JModelList
{
...
$result = $db->query();
	...
	function setOptions() {
        ...
        $this->setdatabase($options['pause-link'], 'pause-link');
		...
		JFactory::getApplication()->enqueueMessage('Your Video options have successfully been saved.  Please note that your Videos will not import until you have activated the <a href="index.php?option=com_plugins">bundled cron plugin</a>.');
	}
