...
INSERT IGNORE INTO  `#__brafton_options` (`option`,`value`) VALUES ('api-key',  ''), ('base-url',  ''), ('author', ''), ('import-order', ''), ('published-state', ''), ('update-articles', ''), ('parent-category', 1), ('secret-key', ''), ('public-key', ''), ('feed-number', 0), ('import-assets', '');